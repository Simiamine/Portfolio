      ...
      <nav className="mx-auto max-w-6xl flex items-center justify-between px-4 sm:px-6 h-14">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="hidden sm:inline-flex text-xs font-medium px-3 py-1.5 rounded-md bg-primary-dark text-white hover:bg-primary-light transition-colors"
          >
            {t("resume")}
          </a>
        ...
        <div className="md:hidden border-t border-border bg-background/95 backdrop-blur-md">
          <div className="flex flex-col px-4 py-3 gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-primary-dark font-medium py-1.5"
            >
              {t("resume")}
            </a>
          </div>
