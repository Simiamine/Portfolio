...
export const PROJECTS: Project[] = [
  {
    ...
    description: {
      fr: "Un profil unique qui alimente CV, portfolio web et recherche d'emploi. 315+ utilisateurs en production, 87% de profils completes. Import LinkedIn/GitHub, matching semantique, generation de lettres de motivation, scraping d'offres, gamification, module B2B ecoles. Projet lance en equipe de 5, role de CEO / Founding Technical Lead.",
      en: "A single profile that feeds your resume, web portfolio, and job search. 315+ users in production, 87% profile completion. LinkedIn/GitHub import, semantic matching, cover letter generation, job scraping, gamification, B2B module for schools. Launched with a team of 5, CEO / Founding Technical Lead role.",
    },
    stack: [
      "React/Vite",
      "FastAPI",
...
export const SKILLS = {
  ...
  ml_ai: [
    ...
    "ChromaDB",
    "SageMaker",
    "MLOps (serving, registry, monitoring)",
  ],
  backend: [
    "FastAPI",
    "PostgreSQL",
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    description: {
      fr: [
        ...
        "Data warehouse dbt sur Snowflake (4 couches, modele dimensionnel fact/dimension)",
        "ML gap assessment (XGBoost, SHAP) pour le transfert technologique",
        "Mise en production du modele ML (MLOps) : serving temps reel (FastAPI + Lambda), training/registry SageMaker, gate qualite, monitoring de derive",
      ...
      en: [
        ...
        "dbt data warehouse on Snowflake (4 layers, fact/dimension dimensional model)",
        "ML gap assessment (XGBoost, SHAP) for technology transfer",
        "ML model productionization (MLOps): real-time serving (FastAPI + Lambda), SageMaker training/registry, quality gate, drift monitoring",
  ...
  },
  {
    ...
    role: {
      fr: "Data Expert — Vehicules autonomes (Alternance)",
      en: "Data Expert — Autonomous Vehicles (Work-Study)",
    },
    location: "Paris",
    period: "Aout 2024 — Sept. 2025",
    description: {
      fr: [
        "Recrute pour de la data science, devenu seul profil data de l'equipe : prise en charge de tout le perimetre data en autonomie",
        "Traitement de flux Kafka temps reel via PySpark Structured Streaming",
        "Pipelines de transformation avec AWS Glue pour l'analytique aval",
        "Dashboards de suivi de flotte : Amazon QuickSight et interfaces React (Vite)",
        "AWS (S3, Glue) avec Terraform pour le provisioning",
      ],
      en: [
        "Recruited for data science, became the team's sole data profile: owned the full data scope end-to-end and autonomously",
        "Real-time Kafka feed processing via PySpark Structured Streaming",
        "Transformation pipelines with AWS Glue for downstream analytics",
        "Fleet monitoring dashboards: Amazon QuickSight and React (Vite) interfaces",
        "AWS (S3, Glue) with Terraform for provisioning",
      ],
    },
  },
  {
    ...
    description: {
      fr: [
        "Automatisation du reporting RH via VBA (Excel)",
        "Creation de tableaux de bord Excel & Power BI pour la direction",
        "Conseil en strategie IA pour la DRH : cas d'usage et roadmap d'integration",
        "Solution d'IA generative de traduction de supports video avec synchronisation labiale pour le recrutement international",
      ],
      en: [
        "HR reporting automation via VBA (Excel)",
        "Excel & Power BI dashboards for management",
        "AI strategy consulting for the HR department: use cases and integration roadmap",
        "Generative-AI solution to translate recruitment videos with natural lip-sync for international candidates",
      ],
    },
  },
  {
